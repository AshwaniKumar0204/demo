            ...
            if ($scope.IsFormValid) {
                ...
                var AdmissionModel = {
                    ...
                    Student: {
                        ...
                        IntermediatePreviousSchoolName: $scope.Admission.IntermediatePreviousSchoolName,
                        IntermediatePreviousBoardName: $scope.Admission.IntermediatePreviousBoardName,
                        IntermediateLastClassAttend: $scope.Admission.IntermediateLastClassAttend,
                        IntermediateMediumOfInstruction: $scope.Admission.IntermediateMediumOfInstruction,
                        IntermediatePreviousSchoolTCNo: $scope.Admission.IntermediatePreviousSchoolTCNo,
                        IntermediatePreviousSchoolTCIssueDate: loadDataService.getDateTime ($scope.Admission.IntermediatePreviousSchoolTCIssueDate),
