(function () {
    ...
    angular
        .module('app')
        .controller('UpdateFeePaymentStatusController', UpdateFeePaymentStatusController);

    UpdateFeePaymentStatusController.$inject = ["$scope", "adminService", "Factory", "loadDataService", "ConstantData"];

    function UpdateFeePaymentStatusController($scope, adminService, Factory, loadDataService, ConstantData) {
        ...
        $scope.getPendingFeePaymentTempList = function () {
            ...
            adminService.getPendingFeePaymentTempList(loadDataService.getDateMMDDYYYY($scope.FromDate), loadDataService.getDateMMDDYYYY($scope.ToDate), 0)
