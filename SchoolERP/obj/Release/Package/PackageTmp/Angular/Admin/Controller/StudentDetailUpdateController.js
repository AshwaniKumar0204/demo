            ...
            adminService.getAdmissionDetail(AdmissionId)
                .then(function (response) {
                    if (response.data.Message == 'Success') {
                        ...
                        //////////////////////////////////////////////////////Adarsh/////////////////////////////////////
                        if ($scope.Student.IntermediatePreviousSchoolTCIssueDate != null)
                            $scope.Student.IntermediatePreviousSchoolTCIssueDate = new Date($scope.Student.IntermediatePreviousSchoolTCIssueDate);
        ...
        $scope.updateStudentDetail = function () {
            ...
            if ($scope.IsFormValid) {
                var StudentModel = {
                    ...
                    IntermediatePreviousSchoolName: $scope.Student.IntermediatePreviousSchoolName,
                    IntermediatePreviousBoardName: $scope.Student.IntermediatePreviousBoardName,
                    IntermediateLastClassAttend: $scope.Student.IntermediateLastClassAttend,
                    IntermediateMediumOfInstruction: $scope.Student.IntermediateMediumOfInstruction,
                    IntermediatePreviousSchoolTCNo: $scope.Student.IntermediatePreviousSchoolTCNo,
                    IntermediatePreviousSchoolTCIssueDate: loadDataService.getDateTime($scope.Student.IntermediatePreviousSchoolTCIssueDate), 
