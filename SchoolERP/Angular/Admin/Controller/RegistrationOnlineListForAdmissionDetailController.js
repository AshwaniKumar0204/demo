(function () {
    ...
    angular
        .module('app')
        .controller('RegistrationOnlineListForAdmissionDetailController', RegistrationOnlineListForAdmissionDetailController);

    RegistrationOnlineListForAdmissionDetailController.$inject = ['$scope', 'adminService', 'Factory', 'ConstantData', '$location'];

    function RegistrationOnlineListForAdmissionDetailController($scope, adminService, Factory, ConstantData, $location) {
        ...
        $scope.getRegistrationOnlineList = function () {
            ...
            $scope.dataLoading = true;
            adminService.getRegistrationOnlineListForAdmissionDetail(obj)
                .then(function (response) {
                    if (response.data.Message == 'Success') {
