(function () {
    ...
    FeeDueReportController.$inject = ['$scope', 'adminService', 'Factory', 'ConstantData'];

    function FeeDueReportController($scope, adminService, Factory, ConstantData) {
        ...
        $scope.getFeeDueReport = function () {
            ...
            $scope.dataLoading = true;
            adminService.getFeeDueReport(obj)
                .then(function (response) {
                    if (response.data.Message == 'Success') {
