(function () {
    ...
    angular
        .module('app')
        .controller('DailyConcessionReportController', DailyConcessionReportController);

    DailyConcessionReportController.$inject = ['$scope', 'adminService', 'Factory', 'ConstantData', 'loadDataService'];

    function DailyConcessionReportController($scope, adminService, Factory, ConstantData, loadDataService) {
        ...
        $scope.getDailyConcessionReport = function () {
            ...
            $scope.dataLoading = true;
            adminService.getDailyConcessionReport(DCRRequest)
                .then(function (response) {
                    if (response.data.Message == 'Success') {
