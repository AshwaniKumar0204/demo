(function () {
    ...
    angular
        .module('app')
        .controller('RegistrationOnlineController', RegistrationOnlineController);

    RegistrationOnlineController.$inject = ["$scope", "adminService", "loadDataService", "Factory", "ConstantData"];

    function RegistrationOnlineController($scope, adminService, loadDataService, Factory, ConstantData) {
        ...
        $scope.saveRegistrationOnline = function () {
            $scope.IsSubmitted = true;
            if ($scope.isFormValid) {
                $scope.dataLoading = true;
                $scope.RegistrationOnline.DOB = loadDataService.getDateTime($scope.RegistrationOnline.DOB);
                adminService.saveRegistrationOnline($scope.RegistrationOnline)
                    .then(function (response) {
                        if (response.data.Message == 'Success') {
